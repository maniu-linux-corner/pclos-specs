...
Source0:	https://codeload.github.com/majn/telegram-purple/tar.gz/telegram-purple-%{version}.tar.gz

BuildRequires:	gettext, %{_lib}gcrypt-devel >= 1.6, pkgconfig(zlib), pkgconfig(purple), pkgconfig(libwebp)
...
%prep
%setup -q -n telegram-purple-%{version}
