Name: kde4-config-sk
Summary: Konfigurace prostředí KDE SC pro slovenské uživatele
Version: 1.0.1
Release: 10
License: GPL v2
...
Conflicts: kde4-config-cs
Requires: oxygen-gtk
Source0: kde4-config-sk.tar.xz
Buildroot: %{_tmppath}/%{name}-%{version}-buildroot
%description
Konfigurace prostředí KDE pro slovenské uživatele

Konfigurační soubory, které lokalizují prostředí KDE do slovenštiny
%prep
%setup -c kde4-config-sk
...
#rm $RPM_BUILD_ROOT/tmp/kdm.sh

%clean
[ "$RPM_BUILD_ROOT" != "/" ] && rm -rf $RPM_BUILD_ROOT

%post
sh /tmp/en-na-sk-kde.sh
rm /tmp/en-na-sk-kde.sh
...
/etc/skel/.config/user-dirs.dirs
   ...
   /etc/skel/.kde4/share/config/konq_history
...
/etc/skel/Stiahnuté/.directory
/etc/skel/Video/.directory
/tmp/en-na-sk-kde.sh
...
/.directory
   ...
   /etc/skel/.kde4/share/config/digikamrc
   ...
   /etc/skel/.kde4/share/config/phonondevicesrc
