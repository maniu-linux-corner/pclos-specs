...
Source0:        https://github.com/xsacha/Sachesi/archive/Sachesi-2.0.3.tar.gz
Source1:        %{name}.desktop

BuildRequires:  openssl-devel, lib64lzo-devel, libusb-devel, quazip-devel
BuildRequires:  qtdeclarative5 qtquickcontrols5
# For i18n - lrelease
BuildRequires:  qttools5
# libudev.so
BuildRequires:  udev
Requires:       qtdeclarative5 qtquickcontrols5
...
%build
/usr/lib64/qt5/bin/qmake -recursive
